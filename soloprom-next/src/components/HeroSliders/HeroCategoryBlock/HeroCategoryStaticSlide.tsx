...
export const HeroCategoryStaticSlide = () => {
  return (
    <div className="hero-vertical-slider__slide h-full">
      <Link
        href={'/catalog/tires'}
        className="hero__card hero__card--link btn-glare relative flex h-full items-center overflow-hidden px-7 pb-[45px] pt-[30px] transition-transform duration-300 ease-in before:absolute before:inset-0 before:z-[1] before:h-full before:w-full before:bg-black before:bg-opacity-60 2xl:rounded-bl-2xl 2xl:rounded-br-custom 2xl:rounded-tl-2xl 2xl:rounded-tr-custom"
      >
