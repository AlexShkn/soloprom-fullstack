...
export const ReviewsTab = ({
  ...
  const createReviewMutation = useMutation({
    ...
    onError: (error: any) => {
      toast.error(
        `Ошибка создания отзыва: ${error?.message || 'Unknown error'}`,
      )
    },
  })
  ...
  return (
    <div className="product-page-tabs__reviews inner-container">
        ...
        !reviews.find((review) => review.userId === userState.id) && (
          <div className="mt-12">
            <form
              ...
              className="mx-auto flex max-w-[500px] flex-col gap-4 rounded p-4 shadow-custom"
            >
