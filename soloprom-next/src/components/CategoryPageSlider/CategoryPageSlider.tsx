            ...
            {isReady ? (
              ...
              >
                {categoryList.map((item) => (
                  <SwiperSlide
                    key={item.href}
                    className="swiper-slide page-category-slider__category-link relative flex min-w-48 select-none flex-col items-center justify-center rounded-custom px-2.5 py-5 text-center shadow-custom transition-all"
                  >
