...
export const Agreement: React.FC<Props> = ({ className }) => {
  return (
    <section className="policy">
      <div className="page-container">
        ...
        <h2 className="mb-2.5 text-lg font-medium">1. Общие положения</h2>
        <p className="policy__first-text-block mb-2.5">
          ...
          безопасности персональных данных, предпринимаемые soloprom.ru (далее —
          Оператор).
        </p>
        <p className="mb-2.5">
        ...
        <p className="mb-2.5">
          ...
          Оператор может получить о посетителях веб-сайта soloprom.ru.
        </p>
        ...
        <p className="mb-2.5">
          ...
          сети интернет по сетевому адресу soloprom.ru.
        </p>
        <p className="mb-2.5">
        ...
        <p className="mb-2.5">
          2.10. Пользователь — любой посетитель веб-сайта soloprom.ru.
        </p>
        <p className="mb-2.5">
        ...
        <p className="policy__first-text-block">
        ...
        <p className="mb-2.5">
          ...
          solo.vrn@mail.ru с пометкой «Актуализация персональных данных».
        </p>
        <p className="mb-2.5">
          ...
          на электронный адрес Оператора solo.vrn@mail.ru с пометкой «Отзыв
        ...
        <p className="mb-2.5">
          ...
          Оператору с помощью электронной почты solo.vrn@mail.ru.
        </p>
        <p className="mb-2.5">
