...
export const SocialAuthButtons: React.FC<Props> = ({ className }) => {
  return (
    <div className="mt-5 flex flex-col gap-4">
      <button className="button flex h-10 items-center bg-[#e2e2e4] text-darkBlue hover:text-white">
      ...
      <button className="button flex h-10 items-center bg-[#e2e2e4] text-darkBlue hover:text-white">
        <div className="flex items-center gap-2 font-medium">
          ...
          <span className="leading-none">Войти с Google</span>
        </div>
      </button>
    </div>
  )
