...
export interface ApiPagesSearchPagesSearch extends Struct.CollectionTypeSchema {
  collectionName: 'pages_searches';
  info: {
    displayName: 'PagesSearch';
    pluralName: 'pages-searches';
    singularName: 'pages-search';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiProductDescrProductDescr
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::product-descr.product-descr'
    > &
      Schema.Attribute.Private;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    categoryId: Schema.Attribute.Relation<'oneToOne', 'api::category.category'>;
    ...
    models: Schema.Attribute.JSON;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    plates: Schema.Attribute.String;
    popular_product: Schema.Attribute.Relation<
      'oneToOne',
      'api::popular-product.popular-product'
    >;
    product_descr: Schema.Attribute.Relation<
      'oneToOne',
      'api::product-descr.product-descr'
    >;
    productId: Schema.Attribute.String &
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::pages-search.pages-search': ApiPagesSearchPagesSearch;
      'api::popular-product.popular-product': ApiPopularProductPopularProduct;
      'api::product-descr.product-descr': ApiProductDescrProductDescr;
